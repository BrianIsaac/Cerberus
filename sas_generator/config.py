...
class Settings(BaseSettings):
    ...
    dd_service: str = Field(default="sas-generator", alias="DD_SERVICE")
    dd_env: str = Field(default="production", alias="DD_ENV")
    dd_version: str = Field(default="0.1.0", alias="DD_VERSION")
    dd_llmobs_ml_app: str = Field(default="sas-generator", alias="DD_LLMOBS_ML_APP")
    ...
    sas_api_url: str = Field(
        default="http://localhost:8080",
        alias="SAS_API_URL",
        description="URL of the SAS Generator backend API",
    )
